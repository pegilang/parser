...
//NIL_LIT                : 'nil';
//
IDENTIFIER             : LETTER ((LETTER | '-' | UNICODE_DIGIT)* LETTER)?;
...
//EOF_STRING_LIT_1: '<<EOF' .*? 'EOF';
//EOF_STRING_LIT_2: '<<EOF' ('\n' ('\t\t' ~[\r\n]*)?)* '\n\tEOF';
//EOF_STRING_LIT_3: '<<EOF' ('\n' ('\t\t\t' ~[\r\n]*)?)* '\n\t\tEOF';
//EOF_STRING_LIT: EOF_STRING_LIT_1 | EOF_STRING_LIT_2 | EOF_STRING_LIT_3;
